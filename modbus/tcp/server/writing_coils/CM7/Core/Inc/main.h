...
#define COIL1_Pin GPIO_PIN_10
#define COIL1_GPIO_Port GPIOE
#define COIL2_Pin GPIO_PIN_12
#define COIL2_GPIO_Port GPIOE
#define COIL3_Pin GPIO_PIN_15
#define COIL3_GPIO_Port GPIOE
#define COIL4_Pin GPIO_PIN_10
#define COIL4_GPIO_Port GPIOB
#define COIL5_Pin GPIO_PIN_11
#define COIL5_GPIO_Port GPIOB
