...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, COIL1_Pin|COIL2_Pin|COIL3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, COIL4_Pin|COIL5_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : COIL4_Pin COIL5_Pin */
  GPIO_InitStruct.Pin = COIL4_Pin|COIL5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : INPUT5_Pin */
  GPIO_InitStruct.Pin = INPUT5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(INPUT5_GPIO_Port, &GPIO_InitStruct);
