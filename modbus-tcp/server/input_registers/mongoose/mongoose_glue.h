...
bool glue_get_input_registers(struct input_registers *, size_t index);
void glue_set_input_registers(struct input_registers *, size_t index);

struct holding_registers {
  int value;
};
bool glue_get_holding_registers(struct holding_registers *, size_t index);
void glue_set_holding_registers(struct holding_registers *, size_t index);
