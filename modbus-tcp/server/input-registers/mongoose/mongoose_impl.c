...
struct attribute s_input_registers_attributes[] = {
  {"value", "int", NULL, offsetof(struct input_registers, value), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_holding_registers_attributes[] = {
  {"value", "int", NULL, offsetof(struct holding_registers, value), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_array s_apihandler_input_registers = {{"input_registers", "array", true, 0, 0, 0UL}, s_input_registers_attributes, sizeof(struct input_registers), (bool (*)(void *, size_t)) glue_get_input_registers, (void (*)(void *, size_t)) glue_set_input_registers};
struct apihandler_array s_apihandler_holding_registers = {{"holding_registers", "array", false, 0, 0, 0UL}, s_holding_registers_attributes, sizeof(struct holding_registers), (bool (*)(void *, size_t)) glue_get_holding_registers, (void (*)(void *, size_t)) glue_set_holding_registers};

static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_input_registers,
  (struct apihandler *) &s_apihandler_holding_registers
};
